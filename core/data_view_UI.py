...
class Ui_DataView(object):
    def setupUi(self, DataView):
        ...
        self.uiFilterGLay = QtWidgets.QGridLayout()
        self.uiFilterGLay.setObjectName("uiFilterGLay")
        ...
        self.uiFilterGLay.addWidget(self.uiFilterLbl, 0, 0, 1, 1)
        self.uiTableVlay.addLayout(self.uiFilterGLay)

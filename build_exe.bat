...
@echo off
set PATH=%OSGEO4W_ROOT%\apps\qgis-ltr\bin;C:\work\Projekte\AlmGIS\almgis\venv_02\Scripts;%OSGEO4W_ROOT%\apps\Qt5\bin;%OSGEO4W_ROOT%\apps\Python312\Scripts:%PATH%
